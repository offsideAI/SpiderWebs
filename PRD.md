...
- It does not automatically open PRs or push fixes in v1 (it *recommends*; auto-fix is a v2 stretch goal).
...
- Subcommands: `scan`, `report`, `sbom`, `db update`, `config`, `version`.
...
**v2 stretch:** auto-fix PR generation, reachability/dataflow improvements, plugin SDK for
custom scanners, scheduled/watch mode.
